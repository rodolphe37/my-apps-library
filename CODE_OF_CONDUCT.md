...
*[Français ci-dessous ⬇️](#code-de-conduite-de-la-communauté-contributor-covenant)*
...
reported to the maintainer via a private GitHub message to
[**@rodolphe37**](https://github.com/rodolphe37), or by email at the address
listed on that GitHub profile. All complaints will be reviewed and
investigated promptly and fairly, and the reporter's privacy and security
will be respected.
...
# Code de conduite de la communauté (Contributor Covenant)

*[English above ⬆️](#contributor-covenant-code-of-conduct)*

## Notre engagement

En tant que membres, contributeurs et responsables, nous nous engageons à
faire de la participation à notre communauté une expérience sans harcèlement
pour tout le monde, quel que soit l'âge, la corpulence, le handicap visible
ou invisible, l'origine ethnique, les caractéristiques sexuelles, l'identité
et l'expression de genre, le niveau d'expérience, l'éducation, le statut
socio-économique, la nationalité, l'apparence personnelle, la race, la
...
- Respecter les opinions, points de vue et expériences différents des siens
- Donner et recevoir avec grâce des retours constructifs
- Accepter la responsabilité de ses erreurs, présenter ses excuses aux
  personnes affectées, et apprendre de l'expérience
- Se concentrer sur ce qui est le mieux non seulement pour soi en tant
  qu'individu, mais pour l'ensemble de la communauté

Exemples de comportements inacceptables :

- L'utilisation de langage ou d'images à caractère sexuel, et toute
  attention ou avance de nature sexuelle
- Le trolling, les commentaires insultants ou dégradants, et les attaques
  personnelles ou politiques
- Le harcèlement public ou privé
- La publication d'informations privées d'autrui (adresse physique ou
  email) sans permission explicite
...
nos standards de comportement acceptable, et prendront des mesures
correctives appropriées et justes en réponse à tout comportement qu'ils
jugent inapproprié, menaçant, offensant ou nuisible.

Les mainteneurs ont le droit et la responsabilité de retirer, modifier ou
rejeter les commentaires, commits, code, modifications du wiki, issues et
autres contributions qui ne sont pas alignés avec ce Code de conduite, et
communiqueront les raisons de leurs décisions de modération lorsque cela est
pertinent.
...
Les cas de comportement abusif, harcelant ou autrement inacceptable peuvent
être signalés au mainteneur via un message privé GitHub à
[**@rodolphe37**](https://github.com/rodolphe37), ou par email à l'adresse
indiquée sur ce profil GitHub. Toutes les plaintes seront examinées et
traitées rapidement et équitablement, et la confidentialité et la sécurité
de la personne à l'origine du signalement seront respectées.

## Directives d'application

Les mainteneurs suivront ces Directives d'impact communautaire pour
...
Ce Code de conduite est adapté du [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, disponible à
<https://www.contributor-covenant.org/version/2/1/code_of_conduct.html>, et
de sa [traduction française officielle](https://www.contributor-covenant.org/fr/version/2/1/code_of_conduct/).
